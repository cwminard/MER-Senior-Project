...
startBtn?.addEventListener("click", () => {
  ...
  mediaRecorder = new MediaRecorder(mediaStream, { mimeType: mime, bitsPerSecond: 2_000_000 });
  ...
  tickInterval = setInterval(()=>{ if (timerEl) timerEl.textContent = fmt(Date.now() - startAt); }, 250);
